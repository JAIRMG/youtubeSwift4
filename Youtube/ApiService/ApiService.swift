...
class ApiService: NSObject {
   ...
   /* func fetchVideos(completion: @escaping ([Video]) -> ()) {
            ...
            case 200:
                ...
                do{
                    ...
                    for dictionario in json as! [[String: AnyObject]]{
                        ...
                        video.thumbnail_image_name = dictionario["thumbnail_image_name"] as? String
                        videos.append(video)
    ...
    func fetchTrendingFeed(completion: @escaping ([Video]) -> ()) {
        ...
        let todoEndpoint: String = "https://s3-us-west-2.amazonaws.com/youtubeassets/trending.json"
        guard let url = URL(string: todoEndpoint) else {
            print("Error: cannot create URL")
            return
        }
    ...
    func fetchSubscriptionFeed(completion: @escaping ([Video]) -> ()) {
        ...
        let todoEndpoint: String = "https://s3-us-west-2.amazonaws.com/youtubeassets/subscriptions.json"
        guard let url = URL(string: todoEndpoint) else {
            print("Error: cannot create URL")
            return
        }
